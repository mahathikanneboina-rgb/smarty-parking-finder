...
const moduleDir = process.env.VERCEL ? "/tmp" : import_node_path.default.dirname((0, import_node_url.fileURLToPath)(import_meta.url));
const DB_FILE = process.env.VERCEL ? import_node_path.default.join("/tmp", "smarty-parking-db.json") : import_node_path.default.join(moduleDir, "db.json");
